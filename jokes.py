...
JOKES_XD = [
    ...
    "¿Cómo se dice una caja de té? Té-ka.",
    "¿Cómo se dice disparo en árabe? Ahí-va-la-bala.",
    "¿Qué le dice un gusano a otro gusano? Voy a dar una vuelta a la manzana.",
    """
    Un gato empieza a ladrar en el tejado de una casa. Otro gato, sorprendido, 
    le dice: Estás loco gato, ¿por qué ladras en vez de maullar? 
    El gatito le responde: ¿A caso no puedo aprender otro idioma?
    """,
    """
    El doctor le dice al paciente: respire profundo que lo voy a auscultar. 
    El paciente le responde: doctor, ¿de quién me va a ocultar si no le debo a nadie?
    """,
    """
    Sale el doctor después de un parto y el padre de la criatura 
    le pregunta: ¿Doctor cómo salió todo? 
    ...
    """,
    """
    Un pez le pregunta a otro pez: ¿qué hace tu mamá? 
    Este le contesta: Nada, ¿y la tuya qué hace? Nada también.
    """,
    ...
    La madre le pregunta al niño: ¿Por qué no quieres jugar más con él? 
    Porque cuando jugamos a los tacos de madera y le pego con uno en la cabeza, de repente se pone a llorar.
    """,
    """
    A Juanito le dice la maestra: Juanito, ¿qué harías si te estuvieses ahogando en la piscina? 
    Juanito le responde: Me pondría a llorar mucho para desahogarme.
    """,
    ...
    """
    Le dice la maestra a Jaimito: Jaimito, ¿cómo se dice en inglés "el gato se cayó al agua y se ahogó?" 
    Fácil profe, se dice "The cat cataplum in the water gluglu no more miau miau".
    """,
    """
    Una amiga le dice a otra amiga: ¿Qué tal va la vida de casada? 
    Pues no me puedo quejar, dice ella. ¿O sea que va muy bien, no? 
